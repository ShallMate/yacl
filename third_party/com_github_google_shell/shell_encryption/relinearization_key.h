...
struct RelinearizationApplyTiming {
  std::uint64_t inverse_ntt_us = 0;
  std::uint64_t bit_decompose_matrix_us = 0;
  std::uint64_t export_coeffs_us = 0;
  std::uint64_t digit_extract_us = 0;
  std::uint64_t convert_ntt_us = 0;
  std::uint64_t fused_muladd_us = 0;
};
