...
class RlweContext {
 ...
 public:
  ...
  size_t GetLogN() const { return context_params_.log_n; }
  size_t GetN() const { return 1 << context_params_.log_n; }
  size_t GetLogT() const { return context_params_.log_t; }
  const Int GetT() const {
    return (static_cast<Int>(1) << context_params_.log_t) + static_cast<Int>(1);
  }
  size_t GetVariance() const { return context_params_.variance; }
